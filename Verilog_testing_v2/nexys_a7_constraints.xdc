...
## Pmod Header JA (directly next to the switches on the board)
## Used for DAC SPI interface
set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { dac_cs }];    # JA[1]
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { dac_mosi }];  # JA[2]
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { dac_sck }];   # JA[3]

## 7-Segment Display - Segment Cathodes (active low)
...
## 7-Segment Display - Decimal Point Cathode (active low)
