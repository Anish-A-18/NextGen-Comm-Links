`timescale 1ns / 1ps
// ============================================================================
// PAM4 SerDes Demo - Step 1+2+3+4: Composite Channel + Coupling + FFE + ML
// ============================================================================
...
//   Mode 3: Composite FIR + lane coupling -> FFE + DFE -> slicer -> SER (~0.79%)
//   Mode 4: Composite FIR + lane coupling -> FEE + ML NN  -> argmax -> SER (~0%)
//
...
//   Channel A: Modes 1-3: Interpolated output (FIR/coupled/FFE, scaled 12-bit)
//              Mode 4: ML confidence (margin between best and 2nd-best logit)
//   Channel B: Error waveform (0xFFF = error, 0x000 = correct)
//   Channel E: Threshold slicer output (4 discrete PAM4 levels)
//
// 7-Segment Display: "M  XX.XXXX" where M = mode number (1, 2, 3, or 4)
...
module pam4_serdes_step1 (
    ...
    // ML Equalizer: 23 -> 4 ReLU -> 4 ReLU -> 4 argmax
    // Weights in Q6.10 (16-bit signed, 10 fractional bits)
    // Input is coupled_out >>> ML_INPUT_SHIFT (arithmetic right shift)
    localparam ML_INPUT_SHIFT = 6;
    localparam Q_ML           = 10;
    localparam SYMBOL_DELAY_4 = 15;
    ...
    // 15-second mode switch at 100 MHz
    localparam [31:0] MODE_SWITCH_TICKS = 32'd1_500_000_000;
    ...
    // ========================================================================
    // MODE SWITCH TIMER (30 seconds per mode, cycles 0->1->2->3->0...)
    // ========================================================================
    reg [31:0] mode_timer = 0;
    reg [2:0]  active_mode = 0;  // 0=Mode1, 1=Mode2, 2=Mode3, 3=Mode4
    ...
    // ========================================================================
    // ML NEURAL NETWORK EQUALIZER (Mode 4)
    //
    // 23-tap shift register fed from coupled_out (same as FFE).
    // Input pre-scaled by >>> ML_INPUT_SHIFT.
    // 3-layer NN: 23->4 ReLU -> 4 ReLU -> 4 logits -> argmax
    // All MACs are blocking (combinational within the tick).
    // Weights fully unrolled as individual localparams for Verilog-2001.
    // ========================================================================

    // Layer 1 weights [input_idx][hidden_idx], Q6.10
    // Row j, Col k -> w1_j_k: ml_sr[j] * w1_j_k
    localparam signed [15:0] w1_0_0=-16'sd4, w1_0_1=16'sd10, w1_0_2=-16'sd11, w1_0_3=-16'sd18;
    localparam signed [15:0] w1_1_0=16'sd3, w1_1_1=-16'sd14, w1_1_2=16'sd14, w1_1_3=16'sd0;
    localparam signed [15:0] w1_2_0=-16'sd26, w1_2_1=16'sd27, w1_2_2=-16'sd4, w1_2_3=-16'sd4;
    localparam signed [15:0] w1_3_0=16'sd95, w1_3_1=-16'sd59, w1_3_2=16'sd16, w1_3_3=16'sd10;
    localparam signed [15:0] w1_4_0=16'sd234, w1_4_1=16'sd153, w1_4_2=16'sd50, w1_4_3=16'sd369;
    localparam signed [15:0] w1_5_0=16'sd2, w1_5_1=16'sd9, w1_5_2=16'sd135, w1_5_3=16'sd40;
    localparam signed [15:0] w1_6_0=-16'sd10, w1_6_1=16'sd1, w1_6_2=-16'sd21, w1_6_3=-16'sd9;
    localparam signed [15:0] w1_7_0=16'sd57, w1_7_1=16'sd21, w1_7_2=16'sd14, w1_7_3=16'sd56;
    localparam signed [15:0] w1_8_0=-16'sd12, w1_8_1=-16'sd28, w1_8_2=-16'sd12, w1_8_3=-16'sd28;
    localparam signed [15:0] w1_9_0=-16'sd52, w1_9_1=16'sd100, w1_9_2=16'sd86, w1_9_3=16'sd67;
    localparam signed [15:0] w1_10_0=16'sd674, w1_10_1=-16'sd290, w1_10_2=-16'sd167, w1_10_3=16'sd139;
    localparam signed [15:0] w1_11_0=16'sd162, w1_11_1=16'sd219, w1_11_2=16'sd543, w1_11_3=-16'sd111;
    localparam signed [15:0] w1_12_0=-16'sd1, w1_12_1=16'sd0, w1_12_2=16'sd36, w1_12_3=-16'sd84;
    localparam signed [15:0] w1_13_0=16'sd64, w1_13_1=-16'sd4, w1_13_2=16'sd24, w1_13_3=16'sd52;
    localparam signed [15:0] w1_14_0=16'sd59, w1_14_1=16'sd1, w1_14_2=16'sd24, w1_14_3=-16'sd4;
    localparam signed [15:0] w1_15_0=16'sd22, w1_15_1=16'sd6, w1_15_2=16'sd37, w1_15_3=-16'sd28;
    localparam signed [15:0] w1_16_0=-16'sd90, w1_16_1=16'sd38, w1_16_2=16'sd32, w1_16_3=-16'sd6;
    localparam signed [15:0] w1_17_0=-16'sd13, w1_17_1=-16'sd18, w1_17_2=-16'sd85, w1_17_3=16'sd42;
    localparam signed [15:0] w1_18_0=16'sd31, w1_18_1=-16'sd28, w1_18_2=-16'sd22, w1_18_3=16'sd26;
    localparam signed [15:0] w1_19_0=16'sd0, w1_19_1=16'sd24, w1_19_2=16'sd17, w1_19_3=-16'sd4;
    localparam signed [15:0] w1_20_0=-16'sd14, w1_20_1=-16'sd12, w1_20_2=16'sd5, w1_20_3=-16'sd8;
    localparam signed [15:0] w1_21_0=16'sd24, w1_21_1=16'sd3, w1_21_2=-16'sd19, w1_21_3=16'sd14;
    localparam signed [15:0] w1_22_0=16'sd24, w1_22_1=-16'sd5, w1_22_2=16'sd25, w1_22_3=-16'sd13;
    localparam signed [15:0] b1_0=16'sd74, b1_1=16'sd24, b1_2=16'sd53, b1_3=16'sd31;

    // Layer 2 weights [4x4]
    localparam signed [15:0] w2_0_0=16'sd25, w2_0_1=16'sd1062, w2_0_2=-16'sd361, w2_0_3=16'sd823;
    localparam signed [15:0] w2_1_0=-16'sd810, w2_1_1=-16'sd983, w2_1_2=16'sd468, w2_1_3=-16'sd274;
    localparam signed [15:0] w2_2_0=16'sd492, w2_2_1=-16'sd1429, w2_2_2=16'sd626, w2_2_3=16'sd1940;
    localparam signed [15:0] w2_3_0=-16'sd260, w2_3_1=16'sd382, w2_3_2=16'sd164, w2_3_3=-16'sd1337;
    localparam signed [15:0] b2_0=16'sd1540, b2_1=16'sd0, b2_2=-16'sd10, b2_3=16'sd0;

    // Output layer weights [4x4]
    localparam signed [15:0] w3_0_0=16'sd1480, w3_0_1=-16'sd1474, w3_0_2=-16'sd604, w3_0_3=16'sd335;
    localparam signed [15:0] w3_1_0=-16'sd590, w3_1_1=16'sd1058, w3_1_2=16'sd226, w3_1_3=16'sd72;
    localparam signed [15:0] w3_2_0=-16'sd1056, w3_2_1=-16'sd158, w3_2_2=16'sd1452, w3_2_3=-16'sd1520;
    localparam signed [15:0] w3_3_0=-16'sd314, w3_3_1=-16'sd448, w3_3_2=16'sd79, w3_3_3=16'sd713;
    localparam signed [15:0] b3_0=16'sd1904, b3_1=16'sd91, b3_2=-16'sd866, b3_3=-16'sd1129;

    reg signed [15:0] ml_sr [0:22];
    reg [1:0]  det_mode4;
    reg [11:0] dac_a_mode4;
    reg [11:0] dac_e_mode4;

    // Intermediates (blocking)
    reg signed [31:0] ml_a0, ml_a1, ml_a2, ml_a3;
    reg signed [15:0] ml_h1_0, ml_h1_1, ml_h1_2, ml_h1_3;
    reg signed [15:0] ml_h2_0, ml_h2_1, ml_h2_2, ml_h2_3;
    reg signed [31:0] ml_l0, ml_l1, ml_l2, ml_l3;
    reg signed [15:0] ml_s [0:22];
    reg [1:0] ml_argmax;
    reg signed [31:0] ml_best, ml_second;
    reg signed [31:0] ml_margin;
    integer mi;

    always @(posedge clk) begin
        if (symbol_tick) begin
            // Shift register (NB): shift and load coupled_out
            for (mi = 22; mi > 0; mi = mi - 1)
                ml_sr[mi] <= ml_sr[mi-1];
            ml_sr[0] <= coupled_out;

            // Pre-scale inputs (blocking): arithmetic right shift
            for (mi = 0; mi < 23; mi = mi + 1)
                ml_s[mi] = ml_sr[mi] >>> ML_INPUT_SHIFT;

            // Layer 1, node 0
            ml_a0 = ml_s[0]*w1_0_0 + ml_s[1]*w1_1_0 + ml_s[2]*w1_2_0 + ml_s[3]*w1_3_0
                   + ml_s[4]*w1_4_0 + ml_s[5]*w1_5_0 + ml_s[6]*w1_6_0 + ml_s[7]*w1_7_0
                   + ml_s[8]*w1_8_0 + ml_s[9]*w1_9_0 + ml_s[10]*w1_10_0 + ml_s[11]*w1_11_0
                   + ml_s[12]*w1_12_0 + ml_s[13]*w1_13_0 + ml_s[14]*w1_14_0 + ml_s[15]*w1_15_0
                   + ml_s[16]*w1_16_0 + ml_s[17]*w1_17_0 + ml_s[18]*w1_18_0 + ml_s[19]*w1_19_0
                   + ml_s[20]*w1_20_0 + ml_s[21]*w1_21_0 + ml_s[22]*w1_22_0 + b1_0;
            ml_h1_0 = (ml_a0 >>> Q_ML) > 0 ? (ml_a0 >>> Q_ML) : 16'sd0;

            // Layer 1, node 1
            ml_a1 = ml_s[0]*w1_0_1 + ml_s[1]*w1_1_1 + ml_s[2]*w1_2_1 + ml_s[3]*w1_3_1
                   + ml_s[4]*w1_4_1 + ml_s[5]*w1_5_1 + ml_s[6]*w1_6_1 + ml_s[7]*w1_7_1
                   + ml_s[8]*w1_8_1 + ml_s[9]*w1_9_1 + ml_s[10]*w1_10_1 + ml_s[11]*w1_11_1
                   + ml_s[12]*w1_12_1 + ml_s[13]*w1_13_1 + ml_s[14]*w1_14_1 + ml_s[15]*w1_15_1
                   + ml_s[16]*w1_16_1 + ml_s[17]*w1_17_1 + ml_s[18]*w1_18_1 + ml_s[19]*w1_19_1
                   + ml_s[20]*w1_20_1 + ml_s[21]*w1_21_1 + ml_s[22]*w1_22_1 + b1_1;
            ml_h1_1 = (ml_a1 >>> Q_ML) > 0 ? (ml_a1 >>> Q_ML) : 16'sd0;

            // Layer 1, node 2
            ml_a2 = ml_s[0]*w1_0_2 + ml_s[1]*w1_1_2 + ml_s[2]*w1_2_2 + ml_s[3]*w1_3_2
                   + ml_s[4]*w1_4_2 + ml_s[5]*w1_5_2 + ml_s[6]*w1_6_2 + ml_s[7]*w1_7_2
                   + ml_s[8]*w1_8_2 + ml_s[9]*w1_9_2 + ml_s[10]*w1_10_2 + ml_s[11]*w1_11_2
                   + ml_s[12]*w1_12_2 + ml_s[13]*w1_13_2 + ml_s[14]*w1_14_2 + ml_s[15]*w1_15_2
                   + ml_s[16]*w1_16_2 + ml_s[17]*w1_17_2 + ml_s[18]*w1_18_2 + ml_s[19]*w1_19_2
                   + ml_s[20]*w1_20_2 + ml_s[21]*w1_21_2 + ml_s[22]*w1_22_2 + b1_2;
            ml_h1_2 = (ml_a2 >>> Q_ML) > 0 ? (ml_a2 >>> Q_ML) : 16'sd0;

            // Layer 1, node 3
            ml_a3 = ml_s[0]*w1_0_3 + ml_s[1]*w1_1_3 + ml_s[2]*w1_2_3 + ml_s[3]*w1_3_3
                   + ml_s[4]*w1_4_3 + ml_s[5]*w1_5_3 + ml_s[6]*w1_6_3 + ml_s[7]*w1_7_3
                   + ml_s[8]*w1_8_3 + ml_s[9]*w1_9_3 + ml_s[10]*w1_10_3 + ml_s[11]*w1_11_3
                   + ml_s[12]*w1_12_3 + ml_s[13]*w1_13_3 + ml_s[14]*w1_14_3 + ml_s[15]*w1_15_3
                   + ml_s[16]*w1_16_3 + ml_s[17]*w1_17_3 + ml_s[18]*w1_18_3 + ml_s[19]*w1_19_3
                   + ml_s[20]*w1_20_3 + ml_s[21]*w1_21_3 + ml_s[22]*w1_22_3 + b1_3;
            ml_h1_3 = (ml_a3 >>> Q_ML) > 0 ? (ml_a3 >>> Q_ML) : 16'sd0;

            // Layer 2 (4->4 ReLU)
            ml_a0 = ml_h1_0*w2_0_0 + ml_h1_1*w2_1_0 + ml_h1_2*w2_2_0 + ml_h1_3*w2_3_0 + b2_0;
            ml_h2_0 = (ml_a0 >>> Q_ML) > 0 ? (ml_a0 >>> Q_ML) : 16'sd0;
            ml_a1 = ml_h1_0*w2_0_1 + ml_h1_1*w2_1_1 + ml_h1_2*w2_2_1 + ml_h1_3*w2_3_1 + b2_1;
            ml_h2_1 = (ml_a1 >>> Q_ML) > 0 ? (ml_a1 >>> Q_ML) : 16'sd0;
            ml_a2 = ml_h1_0*w2_0_2 + ml_h1_1*w2_1_2 + ml_h1_2*w2_2_2 + ml_h1_3*w2_3_2 + b2_2;
            ml_h2_2 = (ml_a2 >>> Q_ML) > 0 ? (ml_a2 >>> Q_ML) : 16'sd0;
            ml_a3 = ml_h1_0*w2_0_3 + ml_h1_1*w2_1_3 + ml_h1_2*w2_2_3 + ml_h1_3*w2_3_3 + b2_3;
            ml_h2_3 = (ml_a3 >>> Q_ML) > 0 ? (ml_a3 >>> Q_ML) : 16'sd0;

            // Output layer (4->4 logits)
            ml_l0 = ml_h2_0*w3_0_0 + ml_h2_1*w3_1_0 + ml_h2_2*w3_2_0 + ml_h2_3*w3_3_0 + b3_0;
            ml_l1 = ml_h2_0*w3_0_1 + ml_h2_1*w3_1_1 + ml_h2_2*w3_2_1 + ml_h2_3*w3_3_1 + b3_1;
            ml_l2 = ml_h2_0*w3_0_2 + ml_h2_1*w3_1_2 + ml_h2_2*w3_2_2 + ml_h2_3*w3_3_2 + b3_2;
            ml_l3 = ml_h2_0*w3_0_3 + ml_h2_1*w3_1_3 + ml_h2_2*w3_2_3 + ml_h2_3*w3_3_3 + b3_3;

            // Argmax + confidence margin (blocking)
            // Find best and second-best logits
            if (ml_l0 >= ml_l1 && ml_l0 >= ml_l2 && ml_l0 >= ml_l3) begin
                ml_argmax = 2'b00;
                ml_best = ml_l0;
                // second = max of the other three
                ml_second = ml_l1;
                if (ml_l2 > ml_second) ml_second = ml_l2;
                if (ml_l3 > ml_second) ml_second = ml_l3;
            end else if (ml_l1 >= ml_l2 && ml_l1 >= ml_l3) begin
                ml_argmax = 2'b01;
                ml_best = ml_l1;
                ml_second = ml_l0;
                if (ml_l2 > ml_second) ml_second = ml_l2;
                if (ml_l3 > ml_second) ml_second = ml_l3;
            end else if (ml_l2 >= ml_l3) begin
                ml_argmax = 2'b10;
                ml_best = ml_l2;
                ml_second = ml_l0;
                if (ml_l1 > ml_second) ml_second = ml_l1;
                if (ml_l3 > ml_second) ml_second = ml_l3;
            end else begin
                ml_argmax = 2'b11;
                ml_best = ml_l3;
            ...
            // Confidence = margin between best and second-best logit
            // Scale to 12-bit DAC: margin is typically 0..~4000
            // Clamp to [0, 4095] for DAC output
            ml_margin = ml_best - ml_second;
            if (ml_margin < 0)
                dac_a_mode4 <= 12'd0;
            else if (ml_margin > 4095)
                dac_a_mode4 <= 12'hFFF;
            else
                dac_a_mode4 <= ml_margin[11:0];

            det_mode4 <= ml_argmax;

            case (ml_argmax)
                2'b00:   dac_e_mode4 <= SLICER_DAC_00;
                2'b01:   dac_e_mode4 <= SLICER_DAC_01;
                2'b10:   dac_e_mode4 <= SLICER_DAC_10;
                default: dac_e_mode4 <= SLICER_DAC_11;
            endcase
        end
    end
    ...
    wire [1:0] ref_mode4 = ref_sr[SYMBOL_DELAY_4];

    // ========================================================================
    // ACTIVE MODE MUX (4-way)
    // ========================================================================
    reg [1:0]  active_det;
    reg [1:0]  active_ref;
    ...
    always @(*) begin
        case (active_mode)
            ...
            default: begin
                active_det   = det_mode4;
                active_ref   = ref_mode4;
                active_dac_a = dac_a_mode4;
                active_dac_e = dac_e_mode4;
            end
        endcase
    end
    ...
    always @(*) begin
        case (active_mode)
            3'd0:    mode_digit = 4'd1;
            3'd1:    mode_digit = 4'd2;
            3'd2:    mode_digit = 4'd3;
            default: mode_digit = 4'd4;
        endcase
    end
